...
public class HomePage {
	...
	public void fill_login(String email, String password) throws InterruptedException {
		...
		System.out.println("email and password entered is : "+ email + " and "+password);
		Thread.sleep(5000);
	}
	...
	//	List<WebElement>  List_items= driver.findElements(By.xpath("//li[@class='list-group-item justify-content-between']"));
		int List_size = List_items.size();
		System.out.println("number of elements in the list is : "+ List_size);
		System.out.println("Name of the elemnts on the list are:");
