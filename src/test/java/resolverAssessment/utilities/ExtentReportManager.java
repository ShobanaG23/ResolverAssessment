package resolverAssessment.utilities;
...
public class ExtentReportManager implements ITestListener
{
	...
	{		
		...
		repName="ResolverTestExecution-Report-"+timeStamp+".html";
				
		htmlReporter=new ExtentHtmlReporter(".\\reports\\"+repName);//specify location of the report
				
		htmlReporter.config().setDocumentTitle("Resolver Assessment Automation Report"); // Tile of report
		htmlReporter.config().setReportName("Resolver Assessment Functional Testing"); // name of the report
